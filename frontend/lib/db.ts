  ...
  return {
    ...
    appointments: [
      ...
      },
      {
        ...
        avatar: "https://ui-avatars.com/api/?name=Internal+Ops&background=F59E0B&color=fff",
      ...
      },
      {
        ...
        avatar: "https://ui-avatars.com/api/?name=David+Miller&background=3B82F6&color=fff",
        service: "Platform Walkthrough",
        provider: "Google Calendar",
        status: "Confirmed",
        created_at: new Date().toISOString()
      },
      ...
      },
      {
        ...
        avatar: "https://ui-avatars.com/api/?name=James+Miller&background=6366F1&color=fff",
